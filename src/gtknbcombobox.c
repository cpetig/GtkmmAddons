...
#define GTK_NB_COMBO_BOX_GET_PRIVATE(obj) (G_TYPE_INSTANCE_GET_PRIVATE ((obj), GTK_TYPE_NB_COMBO_BOX, GtkComboBoxPrivate))
...
static void     gtk_nb_combo_box_cell_layout_init     (GtkCellLayoutIface *iface);
static void     gtk_nb_combo_box_cell_editable_init   (GtkCellEditableIface *iface);
static void     gtk_nb_combo_box_finalize             (GObject          *object);
static void     gtk_nb_combo_box_destroy              (GtkObject        *object);

static void     gtk_nb_combo_box_set_property         (GObject         *object,
                                                    guint            prop_id,
                                                    const GValue    *value,
                                                    GParamSpec      *spec);
static void     gtk_nb_combo_box_get_property         (GObject         *object,
                                                    guint            prop_id,
                                                    GValue          *value,
                                                    GParamSpec      *spec);

static void     gtk_nb_combo_box_state_changed        (GtkWidget        *widget,
			                            GtkStateType      previous);
static void     gtk_nb_combo_box_grab_focus           (GtkWidget       *widget);
static void     gtk_nb_combo_box_style_set            (GtkWidget       *widget,
                                                    GtkStyle        *previous);
static void     gtk_nb_combo_box_button_toggled       (GtkWidget       *widget,
                                                    gpointer         data);
static void     gtk_nb_combo_box_button_state_changed (GtkWidget       *widget,
			                            GtkStateType     previous,
						    gpointer         data);
static void     gtk_nb_combo_box_add                  (GtkContainer    *container,
                                                    GtkWidget       *widget);
static void     gtk_nb_combo_box_remove               (GtkContainer    *container,
                                                    GtkWidget       *widget);

static ComboCellInfo *gtk_nb_combo_box_get_cell_info  (GtkComboBox      *combo_box,
                                                    GtkCellRenderer  *cell);

static void     gtk_nb_combo_box_menu_show            (GtkWidget        *menu,
                                                    gpointer          user_data);
static void     gtk_nb_combo_box_menu_hide            (GtkWidget        *menu,
                                                    gpointer          user_data);

static void     gtk_nb_combo_box_set_popup_widget     (GtkComboBox      *combo_box,
                                                    GtkWidget        *popup);
static void     gtk_nb_combo_box_menu_position_below  (GtkMenu          *menu,
                                                    gint             *x,
                                                    gint             *y,
                                                    gint             *push_in,
                                                    gpointer          user_data);
static void     gtk_nb_combo_box_menu_position_over   (GtkMenu          *menu,
                                                    gint             *x,
                                                    gint             *y,
                                                    gint             *push_in,
                                                    gpointer          user_data);
static void     gtk_nb_combo_box_menu_position        (GtkMenu          *menu,
                                                    gint             *x,
                                                    gint             *y,
                                                    gint             *push_in,
                                                    gpointer          user_data);

static gint     gtk_nb_combo_box_calc_requested_width (GtkComboBox      *combo_box,
                                                    GtkTreePath      *path);
static void     gtk_nb_combo_box_remeasure            (GtkComboBox      *combo_box);

static void     gtk_nb_combo_box_unset_model          (GtkComboBox      *combo_box);

static void     gtk_nb_combo_box_size_request         (GtkWidget        *widget,
                                                    GtkRequisition   *requisition);
static void     gtk_nb_combo_box_size_allocate        (GtkWidget        *widget,
                                                    GtkAllocation    *allocation);
static void     gtk_nb_combo_box_forall               (GtkContainer     *container,
                                                    gboolean          include_internals,
                                                    GtkCallback       callback,
                                                    gpointer          callback_data);
static gboolean gtk_nb_combo_box_expose_event         (GtkWidget        *widget,
                                                    GdkEventExpose   *event);
static gboolean gtk_nb_combo_box_scroll_event         (GtkWidget        *widget,
                                                    GdkEventScroll   *event);
static void     gtk_nb_combo_box_set_active_internal  (GtkComboBox      *combo_box,
						    GtkTreePath      *path);
static gboolean gtk_nb_combo_box_key_press            (GtkWidget        *widget,
						    GdkEventKey      *event,
						    gpointer          data);

static void     gtk_nb_combo_box_check_appearance     (GtkComboBox      *combo_box);
static gchar *  gtk_nb_combo_box_real_get_active_text (GtkComboBox      *combo_box);

/* listening to the model */
static void     gtk_nb_combo_box_model_row_inserted   (GtkTreeModel     *model,
						    GtkTreePath      *path,
						    GtkTreeIter      *iter,
						    gpointer          user_data);
static void     gtk_nb_combo_box_model_row_deleted    (GtkTreeModel     *model,
						    GtkTreePath      *path,
						    gpointer          user_data);
static void     gtk_nb_combo_box_model_rows_reordered (GtkTreeModel     *model,
						    GtkTreePath      *path,
						    GtkTreeIter      *iter,
						    gint             *new_order,
						    gpointer          user_data);
static void     gtk_nb_combo_box_model_row_changed    (GtkTreeModel     *model,
						    GtkTreePath      *path,
						    GtkTreeIter      *iter,
						    gpointer          data);
static void     gtk_nb_combo_box_model_row_expanded   (GtkTreeModel     *model,
						    GtkTreePath      *path,
						    GtkTreeIter      *iter,
						    gpointer          data);

/* list */
static void     gtk_nb_combo_box_list_position        (GtkComboBox      *combo_box, 
						    gint             *x, 
						    gint             *y, 
						    gint             *width,
						    gint             *height);
static void     gtk_nb_combo_box_list_setup           (GtkComboBox      *combo_box);
static void     gtk_nb_combo_box_list_destroy         (GtkComboBox      *combo_box);

static gboolean gtk_nb_combo_box_list_button_released (GtkWidget        *widget,
                                                    GdkEventButton   *event,
                                                    gpointer          data);
static gboolean gtk_nb_combo_box_list_key_press       (GtkWidget        *widget,
                                                    GdkEventKey      *event,
                                                    gpointer          data);
static gboolean gtk_nb_combo_box_list_enter_notify    (GtkWidget        *widget,
                                                    GdkEventCrossing *event,
                                                    gpointer          data);
static void     gtk_nb_combo_box_list_auto_scroll     (GtkComboBox   *combo,
						    gint           x,
						    gint           y);
static gboolean gtk_nb_combo_box_list_scroll_timeout  (GtkComboBox   *combo);
static gboolean gtk_nb_combo_box_list_button_pressed  (GtkWidget        *widget,
                                                    GdkEventButton   *event,
                                                    gpointer          data);

static gboolean gtk_nb_combo_box_list_select_func     (GtkTreeSelection *selection,
						    GtkTreeModel     *model,
						    GtkTreePath      *path,
						    gboolean          path_currently_selected,
						    gpointer          data);

static void     gtk_nb_combo_box_list_row_changed     (GtkTreeModel     *model,
                                                    GtkTreePath      *path,
                                                    GtkTreeIter      *iter,
                                                    gpointer          data);
static void     gtk_nb_combo_box_list_popup_resize    (GtkComboBox      *combo_box);

/* menu */
static void     gtk_nb_combo_box_menu_setup           (GtkComboBox      *combo_box,
                                                    gboolean          add_children);
static void     gtk_nb_combo_box_menu_fill            (GtkComboBox      *combo_box);
static void     gtk_nb_combo_box_menu_fill_level      (GtkComboBox      *combo_box,
						    GtkWidget        *menu,
						    GtkTreeIter      *iter);
static void     gtk_nb_combo_box_update_title         (GtkComboBox      *combo_box);
static void     gtk_nb_combo_box_menu_destroy         (GtkComboBox      *combo_box);

static void     gtk_nb_combo_box_relayout_item        (GtkComboBox      *combo_box,
						    GtkWidget        *item,
                                                    GtkTreeIter      *iter,
						    GtkWidget        *last);
static void     gtk_nb_combo_box_relayout             (GtkComboBox      *combo_box);

static gboolean gtk_nb_combo_box_menu_button_press    (GtkWidget        *widget,
                                                    GdkEventButton   *event,
                                                    gpointer          user_data);
static void     gtk_nb_combo_box_menu_item_activate   (GtkWidget        *item,
                                                    gpointer          user_data);
static void     gtk_nb_combo_box_menu_row_inserted    (GtkTreeModel     *model,
                                                    GtkTreePath      *path,
                                                    GtkTreeIter      *iter,
                                                    gpointer          user_data);
static void     gtk_nb_combo_box_menu_row_deleted     (GtkTreeModel     *model,
                                                    GtkTreePath      *path,
                                                    gpointer          user_data);
static void     gtk_nb_combo_box_menu_rows_reordered  (GtkTreeModel     *model,
						    GtkTreePath      *path,
						    GtkTreeIter      *iter,
						    gint             *new_order,
						    gpointer          user_data);
static void     gtk_nb_combo_box_menu_row_changed     (GtkTreeModel     *model,
                                                    GtkTreePath      *path,
                                                    GtkTreeIter      *iter,
                                                    gpointer          data);
static gboolean gtk_nb_combo_box_menu_key_press       (GtkWidget        *widget,
						    GdkEventKey      *event,
						    gpointer          data);
static void     gtk_nb_combo_box_menu_popup           (GtkComboBox      *combo_box,
						    guint             button, 
...
/* cell layout */
static void     gtk_nb_combo_box_cell_layout_pack_start         (GtkCellLayout         *layout,
                                                              GtkCellRenderer       *cell,
                                                              gboolean               expand);
static void     gtk_nb_combo_box_cell_layout_pack_end           (GtkCellLayout         *layout,
                                                              GtkCellRenderer       *cell,
                                                              gboolean               expand);
static void     gtk_nb_combo_box_cell_layout_clear              (GtkCellLayout         *layout);
static void     gtk_nb_combo_box_cell_layout_add_attribute      (GtkCellLayout         *layout,
                                                              GtkCellRenderer       *cell,
                                                              const gchar           *attribute,
                                                              gint                   column);
static void     gtk_nb_combo_box_cell_layout_set_cell_data_func (GtkCellLayout         *layout,
                                                              GtkCellRenderer       *cell,
                                                              GtkCellLayoutDataFunc  func,
                                                              gpointer               func_data,
                                                              GDestroyNotify         destroy);
static void     gtk_nb_combo_box_cell_layout_clear_attributes   (GtkCellLayout         *layout,
                                                              GtkCellRenderer       *cell);
static void     gtk_nb_combo_box_cell_layout_reorder            (GtkCellLayout         *layout,
                                                              GtkCellRenderer       *cell,
                                                              gint                   position);
static gboolean gtk_nb_combo_box_mnemonic_activate              (GtkWidget    *widget,
							      gboolean      group_cycling);

static void     gtk_nb_combo_box_sync_cells                     (GtkComboBox   *combo_box,
...
static void     combo_cell_data_func                         (GtkCellLayout   *cell_layout,
							      ...
							      GtkTreeIter     *iter,
							      gpointer         data);
static void     gtk_nb_combo_box_child_show                     (GtkWidget       *widget,
							      GtkComboBox     *combo_box);
static void     gtk_nb_combo_box_child_hide                     (GtkWidget       *widget,
							      GtkComboBox     *combo_box);


/* GtkCellEditable method implementations */
static void gtk_nb_combo_box_start_editing (GtkCellEditable *cell_editable,
					 GdkEvent        *event);


G_DEFINE_TYPE_WITH_CODE (GtkComboBox, gtk_nb_combo_box, GTK_TYPE_BIN,
			 G_IMPLEMENT_INTERFACE (GTK_TYPE_CELL_LAYOUT,
						gtk_nb_combo_box_cell_layout_init)
			 G_IMPLEMENT_INTERFACE (GTK_TYPE_CELL_EDITABLE,
						gtk_nb_combo_box_cell_editable_init))

/* common */
static void
gtk_nb_combo_box_class_init (GtkComboBoxClass *klass)
{
  ...
  klass->get_active_text = gtk_nb_combo_box_real_get_active_text;

  container_class = (GtkContainerClass *)klass;
  container_class->forall = gtk_nb_combo_box_forall;
  container_class->add = gtk_nb_combo_box_add;
  container_class->remove = gtk_nb_combo_box_remove;

  widget_class = (GtkWidgetClass *)klass;
  widget_class->size_allocate = gtk_nb_combo_box_size_allocate;
  widget_class->size_request = gtk_nb_combo_box_size_request;
  widget_class->expose_event = gtk_nb_combo_box_expose_event;
  widget_class->scroll_event = gtk_nb_combo_box_scroll_event;
  widget_class->mnemonic_activate = gtk_nb_combo_box_mnemonic_activate;
  widget_class->grab_focus = gtk_nb_combo_box_grab_focus;
  widget_class->style_set = gtk_nb_combo_box_style_set;
  widget_class->state_changed = gtk_nb_combo_box_state_changed;

  gtk_object_class = (GtkObjectClass *)klass;
  gtk_object_class->destroy = gtk_nb_combo_box_destroy;

  object_class = (GObjectClass *)klass;
  object_class->finalize = gtk_nb_combo_box_finalize;
  object_class->set_property = gtk_nb_combo_box_set_property;
  object_class->get_property = gtk_nb_combo_box_get_property;
   ...
   * call to gtk_nb_combo_box_set_active_iter().
...
static void
gtk_nb_combo_box_cell_layout_init (GtkCellLayoutIface *iface)
{
  iface->pack_start = gtk_nb_combo_box_cell_layout_pack_start;
  iface->pack_end = gtk_nb_combo_box_cell_layout_pack_end;
  iface->clear = gtk_nb_combo_box_cell_layout_clear;
  iface->add_attribute = gtk_nb_combo_box_cell_layout_add_attribute;
  iface->set_cell_data_func = gtk_nb_combo_box_cell_layout_set_cell_data_func;
  iface->clear_attributes = gtk_nb_combo_box_cell_layout_clear_attributes;
  iface->reorder = gtk_nb_combo_box_cell_layout_reorder;
}

static void
gtk_nb_combo_box_cell_editable_init (GtkCellEditableIface *iface)
{
  iface->start_editing = gtk_nb_combo_box_start_editing;
}

static void
gtk_nb_combo_box_init (GtkComboBox *combo_box)
{
  combo_box->priv = GTK_NB_COMBO_BOX_GET_PRIVATE (combo_box);
  ...
  gtk_nb_combo_box_check_appearance (combo_box);
}

static void
gtk_nb_combo_box_set_property (GObject      *object,
                            guint         prop_id,
                            const GValue *value,
                            GParamSpec   *pspec)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (object);

  switch (prop_id)
    {
      case PROP_MODEL:
        gtk_nb_combo_box_set_model (combo_box, g_value_get_object (value));
        break;

      case PROP_WRAP_WIDTH:
        gtk_nb_combo_box_set_wrap_width (combo_box, g_value_get_int (value));
        break;

      case PROP_ROW_SPAN_COLUMN:
        gtk_nb_combo_box_set_row_span_column (combo_box, g_value_get_int (value));
        break;

      case PROP_COLUMN_SPAN_COLUMN:
        gtk_nb_combo_box_set_column_span_column (combo_box, g_value_get_int (value));
        break;

      case PROP_ACTIVE:
        gtk_nb_combo_box_set_active (combo_box, g_value_get_int (value));
        break;

      case PROP_ADD_TEAROFFS:
        gtk_nb_combo_box_set_add_tearoffs (combo_box, g_value_get_boolean (value));
        break;
	...
	gtk_nb_combo_box_set_focus_on_click (combo_box, 
					  g_value_get_boolean (value));
        break;

      case PROP_TEAROFF_TITLE:
	gtk_nb_combo_box_set_title (combo_box, g_value_get_string (value));
        break;

      case PROP_POPUP_SHOWN:
        if (g_value_get_boolean (value))
          {
            gtk_nb_combo_box_popup (combo_box);
          }
        else
          {
            gtk_nb_combo_box_popdown (combo_box);
          }
        break;
...
static void
gtk_nb_combo_box_get_property (GObject    *object,
                            guint       prop_id,
                            GValue     *value,
                            GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
      ...
      case PROP_ACTIVE:
        g_value_set_int (value, gtk_nb_combo_box_get_active (combo_box));
        break;

      case PROP_ADD_TEAROFFS:
        g_value_set_boolean (value, gtk_nb_combo_box_get_add_tearoffs (combo_box));
        break;
      ...
      case PROP_TEAROFF_TITLE:
        g_value_set_string (value, gtk_nb_combo_box_get_title (combo_box));
        break;
...
static void
gtk_nb_combo_box_state_changed (GtkWidget    *widget,
			     GtkStateType  previous)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (widget);
...
static void
gtk_nb_combo_box_button_state_changed (GtkWidget    *widget,
				    GtkStateType  previous,
				    gpointer      data)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (data);
...
static void
gtk_nb_combo_box_check_appearance (GtkComboBox *combo_box)
{
  ...
  if (appears_as_list)
	...
	gtk_nb_combo_box_menu_destroy (combo_box);

      /* Create the list mode widgets, if they don't already exist. */
      if (!GTK_IS_TREE_VIEW (combo_box->priv->tree_view))
	gtk_nb_combo_box_list_setup (combo_box);
    }
  else
    {
      /* Destroy all the list mode widgets, if they exist. */
      if (GTK_IS_TREE_VIEW (combo_box->priv->tree_view))
	gtk_nb_combo_box_list_destroy (combo_box);

      /* Create the menu mode widgets, if they don't already exist. */
      if (!GTK_IS_MENU (combo_box->priv->popup_widget))
	gtk_nb_combo_box_menu_setup (combo_box, TRUE);
    }
}

static void
gtk_nb_combo_box_style_set (GtkWidget *widget,
                         GtkStyle  *previous)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (widget);
...
static void
gtk_nb_combo_box_button_toggled (GtkWidget *widget,
                              gpointer   data)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (data);
...
static void
gtk_nb_combo_box_add (GtkContainer *container,
                   GtkWidget    *widget)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (container);
...
static void
gtk_nb_combo_box_remove (GtkContainer *container,
		      GtkWidget    *widget)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (container);
  GtkTreePath *path;
  ...
  if (!combo_box->priv->cell_view)
    {
      ...
      gtk_nb_combo_box_sync_cells (combo_box, GTK_CELL_LAYOUT (combo_box->priv->cell_view));
    }
  ...
  if (gtk_tree_row_reference_valid (combo_box->priv->active_row))
    {
      ...
      gtk_nb_combo_box_set_active_internal (combo_box, path);
      gtk_tree_path_free (path);
    }
  else
    gtk_nb_combo_box_set_active_internal (combo_box, NULL);
}

static ComboCellInfo *
gtk_nb_combo_box_get_cell_info (GtkComboBox     *combo_box,
                             GtkCellRenderer *cell)
{
  GSList *i;
...
static void
gtk_nb_combo_box_menu_show (GtkWidget *menu,
                         gpointer   user_data)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (user_data);

  gtk_nb_combo_box_child_show (menu, user_data);
...
static void
gtk_nb_combo_box_menu_hide (GtkWidget *menu,
                         gpointer   user_data)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (user_data);

  gtk_nb_combo_box_child_hide(menu,user_data);
...
static void
gtk_nb_combo_box_detacher (GtkWidget *widget,
			GtkMenu	  *menu)
{
  GtkComboBox *combo_box;

  g_return_if_fail (GTK_IS_NB_COMBO_BOX (widget));

  combo_box = GTK_NB_COMBO_BOX (widget);
  g_return_if_fail (combo_box->priv->popup_widget == (GtkWidget*) menu);

  g_signal_handlers_disconnect_by_func (menu->toplevel,
					gtk_nb_combo_box_menu_show,
					combo_box);
  g_signal_handlers_disconnect_by_func (menu->toplevel,
					gtk_nb_combo_box_menu_hide,
					combo_box);
...
static void
gtk_nb_combo_box_set_popup_widget (GtkComboBox *combo_box,
                                GtkWidget   *popup)
{
  if (GTK_IS_MENU (combo_box->priv->popup_widget))
    {
  ...
  if (GTK_IS_MENU (popup))
    {
      ...
      g_signal_connect (GTK_MENU (popup)->toplevel, "show",
                        G_CALLBACK (gtk_nb_combo_box_menu_show), combo_box);
      g_signal_connect (GTK_MENU (popup)->toplevel, "hide",
                        G_CALLBACK (gtk_nb_combo_box_menu_hide), combo_box);

      gtk_menu_attach_to_widget (GTK_MENU (popup),
				 GTK_WIDGET (combo_box),
				 gtk_nb_combo_box_detacher);
    }
  else
    {
      if (!combo_box->priv->popup_window)
	  ...
	  g_signal_connect (GTK_WINDOW(combo_box->priv->popup_window),"show",
			    G_CALLBACK (gtk_nb_combo_box_child_show),
			    combo_box);
	  g_signal_connect (GTK_WINDOW(combo_box->priv->popup_window),"hide",
			    G_CALLBACK (gtk_nb_combo_box_child_hide),
			    combo_box);
...
static void
gtk_nb_combo_box_menu_position_below (GtkMenu  *menu,
				   gint     *x,
				   gint     *y,
				   gint     *push_in,
				   gpointer  user_data)
...
static void
gtk_nb_combo_box_menu_position_over (GtkMenu  *menu,
				  gint     *x,
				  gint     *y,
				  gboolean *push_in,
				  gpointer  user_data)
{
  ...
  g_return_if_fail (GTK_IS_NB_COMBO_BOX (user_data));
  
  combo_box = GTK_NB_COMBO_BOX (user_data);
...
static void
gtk_nb_combo_box_menu_position (GtkMenu  *menu,
			     gint     *x,
			     gint     *y,
			     gint     *push_in,
			     gpointer  user_data)
{
  ...
  if (combo_box->priv->wrap_width > 0 || combo_box->priv->cell_view == NULL)	
    gtk_nb_combo_box_menu_position_below (menu, x, y, push_in, user_data);
  else
    {
	...
	gtk_menu_shell_select_item (GTK_MENU_SHELL (combo_box->priv->popup_widget), 
      ...
      gtk_nb_combo_box_menu_position_over (menu, x, y, push_in, user_data);
    }

}

static void
gtk_nb_combo_box_list_position (GtkComboBox *combo_box, 
			     gint        *x, 
			     gint        *y, 
			     gint        *width,
			     gint        *height)
...
static void 
gtk_nb_combo_box_menu_popup (GtkComboBox *combo_box,
			  guint        button, 
			  guint32      activate_time)
{
  GtkTreePath *path;
  ...
  gtk_menu_popup (GTK_MENU (combo_box->priv->popup_widget),
		  NULL, NULL,
		  gtk_nb_combo_box_menu_position, combo_box,
 ...
 **/
void
gtk_nb_combo_box_popup (GtkComboBox *combo_box)
{
  gint x, y, width, height;
  GtkTreePath *path, *ppath;
  GtkWidget *toplevel;

  g_return_if_fail (GTK_IS_NB_COMBO_BOX (combo_box));
  ...
  if (GTK_IS_MENU (combo_box->priv->popup_widget))
    {
      gtk_nb_combo_box_menu_popup (combo_box, 0, 0);
      return;
    }
  ...
  gtk_nb_combo_box_list_position (combo_box, &x, &y, &width, &height);
 ...
 **/
void
gtk_nb_combo_box_popdown (GtkComboBox *combo_box)
{
  g_return_if_fail (GTK_IS_NB_COMBO_BOX (combo_box));
...
static gint
gtk_nb_combo_box_calc_requested_width (GtkComboBox *combo_box,
                                    GtkTreePath *path)
{
  gint padding;
  GtkRequisition req;
...
static void
gtk_nb_combo_box_remeasure (GtkComboBox *combo_box)
{
  GtkTreeIter iter;
  GtkTreePath *path;
...
static void
gtk_nb_combo_box_size_request (GtkWidget      *widget,
                            GtkRequisition *requisition)
{
  gint width, height;
  ...
  gtk_nb_combo_box_remeasure (combo_box);
...
static void
gtk_nb_combo_box_size_allocate (GtkWidget     *widget,
                             GtkAllocation *allocation)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (widget);
  gint focus_width, focus_pad;
...
static void
gtk_nb_combo_box_unset_model (GtkComboBox *combo_box)
{
  if (combo_box->priv->model)
    {
...
static void
gtk_nb_combo_box_forall (GtkContainer *container,
                      gboolean      include_internals,
                      GtkCallback   callback,
                      gpointer      callback_data)
{
...
static void 
gtk_nb_combo_box_child_show (GtkWidget *widget,
                          GtkComboBox *combo_box)
{
...
static void 
gtk_nb_combo_box_child_hide (GtkWidget *widget,
                          GtkComboBox *combo_box)
{
  GtkComboBoxPrivate *priv = combo_box->priv;
...
static gboolean
gtk_nb_combo_box_expose_event (GtkWidget      *widget,
                            GdkEventExpose *event)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (widget);
...
static gboolean
gtk_nb_combo_box_scroll_event (GtkWidget          *widget,
                            GdkEventScroll     *event)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (widget);
  gboolean found;
  ...
  if (!gtk_nb_combo_box_get_active_iter (combo_box, &iter))
    return TRUE;
  ...
  if (found)
    gtk_nb_combo_box_set_active_iter (combo_box, &new_iter);
...
static void
gtk_nb_combo_box_sync_cells (GtkComboBox   *combo_box,
			  GtkCellLayout *cell_layout)
{
  GSList *k;
...
static void
gtk_nb_combo_box_menu_setup (GtkComboBox *combo_box,
                          gboolean     add_children)
{
  GtkWidget *menu;
  ...
  if (combo_box->priv->cell_view)
    {
      ...
      g_signal_connect (combo_box->priv->button, "toggled",
                        G_CALLBACK (gtk_nb_combo_box_button_toggled), combo_box);
      g_signal_connect_after (combo_box->priv->button, 
			      "key_press_event",
			      G_CALLBACK (gtk_nb_combo_box_key_press), combo_box);
  ...
  g_signal_connect (combo_box->priv->button, "button_press_event",
                    G_CALLBACK (gtk_nb_combo_box_menu_button_press),
                    combo_box);
  g_signal_connect (combo_box->priv->button, "state_changed",
		    G_CALLBACK (gtk_nb_combo_box_button_state_changed), 
		    combo_box);

  /* create our funky menu */
  menu = gtk_menu_new ();
  g_signal_connect (menu, "key_press_event",
		    G_CALLBACK (gtk_nb_combo_box_menu_key_press), combo_box);
  gtk_nb_combo_box_set_popup_widget (combo_box, menu);

  /* add items */
  if (add_children)
    gtk_nb_combo_box_menu_fill (combo_box);
  ...
  gtk_nb_combo_box_sync_cells (combo_box, 
			    GTK_CELL_LAYOUT (combo_box->priv->column));

  gtk_nb_combo_box_update_title (combo_box);
}

static void
gtk_nb_combo_box_menu_fill (GtkComboBox *combo_box)
{
  GtkWidget *menu;
  ...
  gtk_nb_combo_box_menu_fill_level (combo_box, menu, NULL);
}
			     ...
			     GtkTreeIter  *iter)
{
  ...
  gtk_nb_combo_box_sync_cells (combo_box, GTK_CELL_LAYOUT (cell_view));
...
static void
gtk_nb_combo_box_menu_fill_level (GtkComboBox *combo_box,
			       GtkWidget   *menu,
			       GtkTreeIter *parent)
{
  ...
  for (i = 0; i < n_children; i++)
      ...
      else
	{
	  ...
	  if (gtk_tree_model_iter_has_child (model, &iter))
	    {
	      ...
	      g_signal_connect (subitem, "activate",
				G_CALLBACK (gtk_nb_combo_box_menu_item_activate),
				combo_box);
	      gtk_menu_shell_append (GTK_MENU_SHELL (submenu), subitem);
	      gtk_menu_shell_append (GTK_MENU_SHELL (submenu), separator);
	      
	      gtk_nb_combo_box_menu_fill_level (combo_box, submenu, &iter);
	    }
	  else
      ...
      if (combo_box->priv->wrap_width && menu == combo_box->priv->popup_widget)
        gtk_nb_combo_box_relayout_item (combo_box, item, &iter, last);
...
static void
gtk_nb_combo_box_menu_destroy (GtkComboBox *combo_box)
{
  g_signal_handlers_disconnect_matched (combo_box->priv->button,
                                        G_SIGNAL_MATCH_DATA,
                                        0, 0, NULL,
                                        gtk_nb_combo_box_menu_button_press, NULL);
  g_signal_handlers_disconnect_matched (combo_box->priv->button,
                                        G_SIGNAL_MATCH_DATA,
                                        0, 0, NULL,
                                        gtk_nb_combo_box_button_state_changed, combo_box);
...
static void
gtk_nb_combo_box_relayout_item (GtkComboBox *combo_box,
			     GtkWidget   *item,
                             GtkTreeIter *iter,
			     GtkWidget   *last)
{
...
static void
gtk_nb_combo_box_relayout (GtkComboBox *combo_box)
{
  GList *list, *j;
  GtkWidget *menu;
...
/* callbacks */
static gboolean
gtk_nb_combo_box_menu_button_press (GtkWidget      *widget,
                                 GdkEventButton *event,
                                 gpointer        user_data)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (user_data);
  ...
  if (GTK_IS_MENU (combo_box->priv->popup_widget) &&
	...
	gtk_widget_grab_focus (combo_box->priv->button);
      ...
      gtk_nb_combo_box_menu_popup (combo_box, event->button, event->time);
...
static void
gtk_nb_combo_box_menu_item_activate (GtkWidget *item,
                                  gpointer   user_data)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (user_data);
  GtkWidget *cell_view;
  ...
  if (gtk_tree_model_get_iter (combo_box->priv->model, &iter, path))
    gtk_nb_combo_box_set_active_iter (combo_box, &iter);
...
static void
gtk_nb_combo_box_model_row_inserted (GtkTreeModel     *model,
				  GtkTreePath      *path,
				  GtkTreeIter      *iter,
				  gpointer          user_data)
{
  ...
  if (combo_box->priv->tree_view)
    gtk_nb_combo_box_list_popup_resize (combo_box);
  else
    gtk_nb_combo_box_menu_row_inserted (model, path, iter, user_data);
}

static void
gtk_nb_combo_box_model_row_deleted (GtkTreeModel     *model,
				 GtkTreePath      *path,
				 gpointer          user_data)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (user_data);
  ...
  if (combo_box->priv->tree_view)
    ...
    gtk_nb_combo_box_menu_row_deleted (model, path, user_data);  
}

static void
gtk_nb_combo_box_model_rows_reordered (GtkTreeModel    *model,
				    GtkTreePath     *path,
				    GtkTreeIter     *iter,
				    gint            *new_order,
				    gpointer         user_data)
{
  ...
  if (!combo_box->priv->tree_view)
    gtk_nb_combo_box_menu_rows_reordered (model, path, iter, new_order, user_data);
}
						    
static void
gtk_nb_combo_box_model_row_changed (GtkTreeModel     *model,
				 GtkTreePath      *path,
				 GtkTreeIter      *iter,
				 gpointer          user_data)
{
  ...
  if (combo_box->priv->tree_view)
    gtk_nb_combo_box_list_row_changed (model, path, iter, user_data);
  else
    gtk_nb_combo_box_menu_row_changed (model, path, iter, user_data);
}
...
static void
gtk_nb_combo_box_list_popup_resize (GtkComboBox *combo_box)
{
...
static void
gtk_nb_combo_box_model_row_expanded (GtkTreeModel     *model,
				  GtkTreePath      *path,
				  GtkTreeIter      *iter,
				  gpointer          user_data)
{
...
static void
gtk_nb_combo_box_menu_row_inserted (GtkTreeModel *model,
                                 GtkTreePath  *path,
                                 GtkTreeIter  *iter,
                                 gpointer      user_data)
{
...
static void
gtk_nb_combo_box_menu_row_deleted (GtkTreeModel *model,
                                GtkTreePath  *path,
                                gpointer      user_data)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (user_data);
...
static void
gtk_nb_combo_box_menu_rows_reordered  (GtkTreeModel     *model,
				    GtkTreePath      *path,
				    GtkTreeIter      *iter,
	      			    gint             *new_order,
				    gpointer          user_data)
{
  ...
  gtk_nb_combo_box_relayout (combo_box);
}
				    
static void
gtk_nb_combo_box_menu_row_changed (GtkTreeModel *model,
                                GtkTreePath  *path,
                                GtkTreeIter  *iter,
                                gpointer      user_data)
{
  ...
  if (is_separator != GTK_IS_SEPARATOR_MENU_ITEM (item))
    {
      gtk_nb_combo_box_menu_row_deleted (model, path, combo_box);
      gtk_nb_combo_box_menu_row_inserted (model, path, iter, combo_box);
    }
  ...
  if (combo_box->priv->wrap_width
      && item->parent == combo_box->priv->popup_widget)
    {
      ...
      /* unattach item so gtk_nb_combo_box_relayout_item() won't spuriously
         move it */
      ...
      gtk_nb_combo_box_relayout_item (combo_box, item, iter, pitem);
    }

  width = gtk_nb_combo_box_calc_requested_width (combo_box, path);
...
static void
gtk_nb_combo_box_list_setup (GtkComboBox *combo_box)
{
  ...
  gtk_widget_set_parent (combo_box->priv->button,
                         GTK_BIN (combo_box)->child->parent);
  g_signal_connect (combo_box->priv->button, "button_press_event",
                    G_CALLBACK (gtk_nb_combo_box_list_button_pressed), combo_box);
  g_signal_connect (combo_box->priv->button, "toggled",
                    G_CALLBACK (gtk_nb_combo_box_button_toggled), combo_box);
  g_signal_connect_after (combo_box, "key_press_event",
			  G_CALLBACK (gtk_nb_combo_box_key_press), combo_box);
  ...
  if (combo_box->priv->cell_view)
      ...
      else 
	{
      ...
      g_signal_connect (combo_box->priv->box, "button_press_event",
			G_CALLBACK (gtk_nb_combo_box_list_button_pressed), 
			combo_box);
    }
  ...
  gtk_tree_selection_set_select_function (sel,
					  gtk_nb_combo_box_list_select_func,
					  NULL, NULL);
  ...
  gtk_nb_combo_box_set_popup_widget (combo_box, combo_box->priv->tree_view);

  g_signal_connect (combo_box->priv->tree_view, "key_press_event",
                    G_CALLBACK (gtk_nb_combo_box_list_key_press),
                    combo_box);
  g_signal_connect (combo_box->priv->tree_view, "enter_notify_event",
                    G_CALLBACK (gtk_nb_combo_box_list_enter_notify),
                    combo_box);
  g_signal_connect (combo_box->priv->tree_view, "row_expanded",
		    G_CALLBACK (gtk_nb_combo_box_model_row_expanded),
		    combo_box);
  ...
  g_signal_connect (combo_box->priv->popup_window, "button_release_event",
                    G_CALLBACK (gtk_nb_combo_box_list_button_released),
                    combo_box);
...
static void
gtk_nb_combo_box_list_destroy (GtkComboBox *combo_box)
{
  /* disconnect signals */
  ...
  g_signal_handlers_disconnect_matched (combo_box->priv->button,
                                        G_SIGNAL_MATCH_DATA,
                                        0, 0, NULL,
                                        gtk_nb_combo_box_list_button_pressed,
                                        NULL);
  ...
  g_signal_handlers_disconnect_matched (combo_box->priv->popup_window,
                                        G_SIGNAL_MATCH_DATA,
                                        0, 0, NULL,
                                        gtk_nb_combo_box_list_button_released,
                                        NULL);

  g_signal_handlers_disconnect_matched (combo_box->priv->popup_window,
					G_SIGNAL_MATCH_DATA,
					0, 0, NULL, 
					gtk_nb_combo_box_child_show,
					NULL);

  g_signal_handlers_disconnect_matched (combo_box->priv->popup_window,
					G_SIGNAL_MATCH_DATA,
					0, 0, NULL, 
					gtk_nb_combo_box_child_hide,
					NULL);
...
static gboolean
gtk_nb_combo_box_list_button_pressed (GtkWidget      *widget,
                                   GdkEventButton *event,
                                   gpointer        data)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (data);
  ...
  if (combo_box->priv->scroll_timer == 0)
    combo_box->priv->scroll_timer = g_timeout_add (SCROLL_TIME, 
						   (GSourceFunc) gtk_nb_combo_box_list_scroll_timeout, 
						   combo_box);
...
static gboolean
gtk_nb_combo_box_list_button_released (GtkWidget      *widget,
                                    GdkEventButton *event,
                                    gpointer        data)
{
  gboolean ret;
...
static gboolean
gtk_nb_combo_box_key_press (GtkWidget   *widget,
			 GdkEventKey *event,
			 gpointer     data)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (data);
...
static gboolean
gtk_nb_combo_box_menu_key_press (GtkWidget   *widget,
			      GdkEventKey *event,
			      gpointer     data)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (data);
...
static gboolean
gtk_nb_combo_box_list_key_press (GtkWidget   *widget,
                              GdkEventKey *event,
                              gpointer     data)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (data);
...
static void
gtk_nb_combo_box_list_auto_scroll (GtkComboBox *combo_box,
				gint         x, 
				gint         y)
{
...
static gboolean
gtk_nb_combo_box_list_scroll_timeout (GtkComboBox *combo_box)
{
  gint x, y;
  ...
  if (combo_box->priv->auto_scroll)
    {
      gdk_window_get_pointer (combo_box->priv->tree_view->window, 
			      &x, &y, NULL);
      gtk_nb_combo_box_list_auto_scroll (combo_box, x, y);
    }
...
static gboolean 
gtk_nb_combo_box_list_enter_notify (GtkWidget        *widget,
				 GdkEventCrossing *event,
				 gpointer          data)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (data);
...
static gboolean
gtk_nb_combo_box_list_select_func (GtkTreeSelection *selection,
				GtkTreeModel     *model,
				GtkTreePath      *path,
				gboolean          path_currently_selected,
				gpointer          data)
...
static void
gtk_nb_combo_box_list_row_changed (GtkTreeModel *model,
                                GtkTreePath  *path,
                                GtkTreeIter  *iter,
                                gpointer      data)
{
...
static void
gtk_nb_combo_box_cell_layout_pack_start (GtkCellLayout   *layout,
                                      GtkCellRenderer *cell,
                                      gboolean         expand)
{
  ComboCellInfo *info;
  ...
  g_return_if_fail (GTK_IS_NB_COMBO_BOX (layout));
  g_return_if_fail (GTK_IS_CELL_RENDERER (cell));

  combo_box = GTK_NB_COMBO_BOX (layout);
...
static void
gtk_nb_combo_box_cell_layout_pack_end (GtkCellLayout   *layout,
                                    GtkCellRenderer *cell,
                                    gboolean         expand)
{
  ComboCellInfo *info;
...
static void
gtk_nb_combo_box_cell_layout_clear (GtkCellLayout *layout)
{
  GtkComboBox *combo_box;
  GSList *i;
  ...
  for (i = combo_box->priv->cells; i; i = i->next)
    {
     ComboCellInfo *info = (ComboCellInfo *)i->data;
      ...
      gtk_nb_combo_box_cell_layout_clear_attributes (layout, info->cell);
...
static void
gtk_nb_combo_box_cell_layout_add_attribute (GtkCellLayout   *layout,
                                         GtkCellRenderer *cell,
                                         const gchar     *attribute,
                                         gint             column)
{
  ...
  info = gtk_nb_combo_box_get_cell_info (combo_box, cell);
...
static void
gtk_nb_combo_box_cell_layout_set_cell_data_func (GtkCellLayout         *layout,
                                              GtkCellRenderer       *cell,
                                              GtkCellLayoutDataFunc  func,
                                              gpointer               func_data,
                                              GDestroyNotify         destroy)
...
static void
gtk_nb_combo_box_cell_layout_clear_attributes (GtkCellLayout   *layout,
                                            GtkCellRenderer *cell)
{
  ComboCellInfo *info;
  GtkComboBox *combo_box;
...
static void
gtk_nb_combo_box_cell_layout_reorder (GtkCellLayout   *layout,
                                   GtkCellRenderer *cell,
                                   gint             position)
{
  ComboCellInfo *info;
 ...
 */
GtkWidget *
gtk_nb_combo_box_new (void)
{
  return g_object_new (GTK_TYPE_NB_COMBO_BOX, NULL);
}

/**
 * gtk_nb_combo_box_new_with_model:
 ...
 */
GtkWidget *
gtk_nb_combo_box_new_with_model (GtkTreeModel *model)
{
  GtkComboBox *combo_box;

  g_return_val_if_fail (GTK_IS_TREE_MODEL (model), NULL);

  combo_box = g_object_new (GTK_TYPE_NB_COMBO_BOX, "model", model, NULL);

  return GTK_WIDGET (combo_box);
}

/**
 * gtk_nb_combo_box_get_wrap_width:
 * @combo_box: A #GtkComboBox.
 *
 ...
 */
gint
gtk_nb_combo_box_get_wrap_width (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_NB_COMBO_BOX (combo_box), -1);

  return combo_box->priv->wrap_width;
}

/**
 * gtk_nb_combo_box_set_wrap_width:
 * @combo_box: A #GtkComboBox.
 ...
 */
void
gtk_nb_combo_box_set_wrap_width (GtkComboBox *combo_box,
                              gint         width)
{
  g_return_if_fail (GTK_IS_NB_COMBO_BOX (combo_box));
...
/**
 * gtk_nb_combo_box_get_row_span_column:
 * @combo_box: A #GtkComboBox.
 *
 ...
 */
gint
gtk_nb_combo_box_get_row_span_column (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_NB_COMBO_BOX (combo_box), -1);
...
/**
 * gtk_nb_combo_box_set_row_span_column:
 * @combo_box: A #GtkComboBox.
 ...
 */
void
gtk_nb_combo_box_set_row_span_column (GtkComboBox *combo_box,
                                   gint         row_span)
{
  gint col;
...
/**
 * gtk_nb_combo_box_get_column_span_column:
 * @combo_box: A #GtkComboBox.
 *
 ...
 */
gint
gtk_nb_combo_box_get_column_span_column (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_NB_COMBO_BOX (combo_box), -1);
...
/**
 * gtk_nb_combo_box_set_column_span_column:
 * @combo_box: A #GtkComboBox.
 ...
 */
void
gtk_nb_combo_box_set_column_span_column (GtkComboBox *combo_box,
                                      gint         column_span)
{
  gint col;
 ...
 */
gint
gtk_nb_combo_box_get_active (GtkComboBox *combo_box)
{
  gint result;
  g_return_val_if_fail (GTK_IS_NB_COMBO_BOX (combo_box), 0);
 ...
 */
void
gtk_nb_combo_box_set_active (GtkComboBox *combo_box,
                          gint         index_)
{
  GtkTreePath *path = NULL;
  g_return_if_fail (GTK_IS_NB_COMBO_BOX (combo_box));
...
static void
gtk_nb_combo_box_set_active_internal (GtkComboBox *combo_box,
				   GtkTreePath *path)
{
  GtkTreePath *active_path;
  gint path_cmp;
...
/**
 * gtk_nb_combo_box_get_active_iter:
 * @combo_box: A #GtkComboBox
 ...
 **/
gboolean
gtk_nb_combo_box_get_active_iter (GtkComboBox     *combo_box,
                               GtkTreeIter     *iter)
{
  GtkTreePath *path;
  gboolean result;

  g_return_val_if_fail (GTK_IS_NB_COMBO_BOX (combo_box), FALSE);
...
/**
 * gtk_nb_combo_box_set_active_iter:
 * @combo_box: A #GtkComboBox
 ...
 **/
void
gtk_nb_combo_box_set_active_iter (GtkComboBox     *combo_box,
                               GtkTreeIter     *iter)
{
  GtkTreePath *path;
  ...
  path = gtk_tree_model_get_path (gtk_nb_combo_box_get_model (combo_box), iter);
  gtk_nb_combo_box_set_active_internal (combo_box, path);
  gtk_tree_path_free (path);
}

/**
 * gtk_nb_combo_box_set_model:
 * @combo_box: A #GtkComboBox.
 * @model: A #GtkTreeModel.
 *
 ...
 * call gtk_nb_combo_box_cell_layout_clear() yourself if you need to set up 
 * different cell renderers for the new model.
 *
 * Since: 2.4
 */
void
gtk_nb_combo_box_set_model (GtkComboBox  *combo_box,
                         GtkTreeModel *model)
{
  g_return_if_fail (GTK_IS_NB_COMBO_BOX (combo_box));
  ...
  if (!model)
    {
      gtk_nb_combo_box_unset_model (combo_box);
      return;
    }
  ...
  combo_box->priv->inserted_id =
    g_signal_connect (combo_box->priv->model, "row_inserted",
		      G_CALLBACK (gtk_nb_combo_box_model_row_inserted),
		      combo_box);
  combo_box->priv->deleted_id =
    g_signal_connect (combo_box->priv->model, "row_deleted",
		      G_CALLBACK (gtk_nb_combo_box_model_row_deleted),
		      combo_box);
  combo_box->priv->reordered_id =
    g_signal_connect (combo_box->priv->model, "rows_reordered",
		      G_CALLBACK (gtk_nb_combo_box_model_rows_reordered),
		      combo_box);
  combo_box->priv->changed_id =
    g_signal_connect (combo_box->priv->model, "row_changed",
		      G_CALLBACK (gtk_nb_combo_box_model_row_changed),
		      combo_box);
 ...
 */
GtkTreeModel *
gtk_nb_combo_box_get_model (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_NB_COMBO_BOX (combo_box), NULL);
 ...
 * following convenience functions: gtk_nb_combo_box_append_text(),
 * gtk_nb_combo_box_insert_text(), gtk_nb_combo_box_prepend_text() and
 * gtk_nb_combo_box_remove_text().
 *
 ...
 */
GtkWidget *
gtk_nb_combo_box_new_text (void)
{
  GtkWidget *combo_box;
  GtkCellRenderer *cell;
  GtkListStore *store;
  ...
  combo_box = gtk_nb_combo_box_new_with_model (GTK_TREE_MODEL (store));
...
/**
 * gtk_nb_combo_box_append_text:
 * @combo_box: A #GtkComboBox constructed using gtk_nb_combo_box_new_text().
 * @text: A string.
 *
 ...
 */
void
gtk_nb_combo_box_append_text (GtkComboBox *combo_box,
                           const gchar *text)
{
  GtkTreeIter iter;
  GtkListStore *store;
 ...
 * with gtk_nb_combo_box_new_text().
 *
 * Since: 2.4
 */
void
gtk_nb_combo_box_insert_text (GtkComboBox *combo_box,
                           gint         position,
                           const gchar *text)
{
  GtkTreeIter iter;
...
/**
 * gtk_nb_combo_box_prepend_text:
 * @combo_box: A #GtkComboBox constructed with gtk_nb_combo_box_new_text().
 * @text: A string.
 *
 ...
 */
void
gtk_nb_combo_box_prepend_text (GtkComboBox *combo_box,
                            const gchar *text)
{
  GtkTreeIter iter;
  GtkListStore *store;
 ...
 * this function with combo boxes constructed with gtk_nb_combo_box_new_text().
 *
 * Since: 2.4
 */
void
gtk_nb_combo_box_remove_text (GtkComboBox *combo_box,
                           gint         position)
{
  GtkTreeIter iter;
  GtkListStore *store;
...
/**
 * gtk_nb_combo_box_get_active_text:
 * @combo_box: A #GtkComboBox constructed with gtk_nb_combo_box_new_text().
 *
 * Returns the currently active string in @combo_box or %NULL if none
 * is selected.  Note that you can only use this function with combo
 * boxes constructed with gtk_nb_combo_box_new_text() and with 
 * #GtkComboBoxEntry<!-- -->s.
 *
 ...
 */
gchar *
gtk_nb_combo_box_get_active_text (GtkComboBox *combo_box)
{
  GtkComboBoxClass *class;

  g_return_val_if_fail (GTK_IS_NB_COMBO_BOX (combo_box), NULL);

  class = GTK_NB_COMBO_BOX_GET_CLASS (combo_box);
...
static gchar *
gtk_nb_combo_box_real_get_active_text (GtkComboBox *combo_box)
{
  GtkTreeIter iter;
  gchar *text = NULL;
...
static gboolean
gtk_nb_combo_box_mnemonic_activate (GtkWidget *widget,
				 gboolean   group_cycling)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (widget);
...
static void
gtk_nb_combo_box_grab_focus (GtkWidget *widget)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (widget);
...
static void
gtk_nb_combo_box_destroy (GtkObject *object)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (object);
  ...
  GTK_OBJECT_CLASS (gtk_nb_combo_box_parent_class)->destroy (object);
  combo_box->priv->cell_view = NULL;
}

static void
gtk_nb_combo_box_finalize (GObject *object)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (object);
  GSList *i;
  ...
  for (i = combo_box->priv->cells; i; i = i->next)
   ...
   G_OBJECT_CLASS (gtk_nb_combo_box_parent_class)->finalize (object);
}
...
popdown_idle (gpointer data)
{
  ...
  combo_box = GTK_NB_COMBO_BOX (data);
...
static void
gtk_nb_combo_box_start_editing (GtkCellEditable *cell_editable,
			     GdkEvent        *event)
{
  GtkComboBox *combo_box = GTK_NB_COMBO_BOX (cell_editable);
...
/**
 * gtk_nb_combo_box_get_add_tearoffs:
 * @combo_box: a #GtkComboBox
 * 
 ...
 **/
gboolean
gtk_nb_combo_box_get_add_tearoffs (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_NB_COMBO_BOX (combo_box), FALSE);
...
/**
 * gtk_nb_combo_box_set_add_tearoffs:
 * @combo_box: a #GtkComboBox 
 ...
 **/
void
gtk_nb_combo_box_set_add_tearoffs (GtkComboBox *combo_box,
...
gtk_nb_combo_box_get_title (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_NB_COMBO_BOX (combo_box), NULL);
...
static void
gtk_nb_combo_box_update_title (GtkComboBox *combo_box)
{
  gtk_nb_combo_box_check_appearance (combo_box);
 ...
 */
void
gtk_nb_combo_box_set_title (GtkComboBox *combo_box,
			 const gchar *title)
{
  g_return_if_fail (GTK_IS_NB_COMBO_BOX (combo_box));
...
gboolean
_gtk_nb_combo_box_editing_canceled (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_NB_COMBO_BOX (combo_box), TRUE);

  return combo_box->priv->editing_canceled;
}

/**
 * gtk_nb_combo_box_get_popup_accessible:
 * @combo_box: a #GtkComboBox
 *
 ...
 **/
AtkObject*
gtk_nb_combo_box_get_popup_accessible (GtkComboBox *combo_box)
{
  AtkObject *atk_obj;
...
/**
 * gtk_nb_combo_box_get_row_separator_func:
 * @combo_box: a #GtkComboBox
 * 
...
gtk_nb_combo_box_get_row_separator_func (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_NB_COMBO_BOX (combo_box), NULL);
...
/**
 * gtk_nb_combo_box_set_row_separator_func:
 * @combo_box: a #GtkComboBox
 ...
 **/
void
gtk_nb_combo_box_set_row_separator_func (GtkComboBox                 *combo_box,
...
/**
 * gtk_nb_combo_box_set_focus_on_click:
 * @combo: a #GtkComboBox
 ...
 **/
void
gtk_nb_combo_box_set_focus_on_click (GtkComboBox *combo_box,
...
/**
 * gtk_nb_combo_box_get_focus_on_click:
 * @combo: a #GtkComboBox
 * 
 * Returns whether the combo box grabs focus when it is clicked 
 * with the mouse. See gtk_nb_combo_box_set_focus_on_click().
 *
 ...
 **/
gboolean
gtk_nb_combo_box_get_focus_on_click (GtkComboBox *combo_box)
{
  g_return_val_if_fail (GTK_IS_NB_COMBO_BOX (combo_box), FALSE);
